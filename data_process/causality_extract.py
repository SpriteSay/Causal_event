...
def test():
    ...
    但续航时间过短，也会影响使用体验。
     """
    content2 = '''
     之所以军工类涨幅靠前，主要是中航飞机的筹划资产置换，刺激了整个大飞机产业链的走强。
     '''
    content3 = '''
    风险提示关注信用风险事件对整体利差的影响。
    投资建议:在海外云计算巨头资本开支回暖、5G商用带动数据流量爆发以及5G工业应用催生边缘计算等多因素的带动下,2020年全球服务器市场有望迎来需求拐点。
    广发基金经理李耀柱：受疫情影响有限科技长牛格局不变新冠肺炎疫情会影响市场短期的风险偏好，短期市场面临回调压力。
    疫情对韩国经济活动的干扰将导致韩国经济今年大幅下滑，GDP在2021年反弹之前将收缩1.5%。
    其二，预期的收入减少，使得单机平均消费金额(ASP)下降；
    是否因为疫情影响，导致产能利用率低？
    今年以来，针对不少生猪养殖户受疫病等因素影响，造成生猪供应量下降。
     '''
